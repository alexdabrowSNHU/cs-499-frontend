  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-0">
        <Link
          to="/dogs"
          className="bg-fuchsia-200/20 text-2xl text-center mb-4 w-[240px] h-[140px] border-2 border-white/70 flex items-center justify-center rounded-lg transition-all duration-200 ease-in-out hover:bg-gray-900/15 hover:scale-105 hover:shadow-lg hover:shadow-gray-700"
        >
          See all dogs
        </Link>
        <Link
